...
public final class SetPropCommand implements CommandHandler {
    ...
    public SetPropCommand() {
		...
		Prop dumbenemy = new Prop("DumbEnemy", PseudoProp.DUMB_ENEMY);
		this.props.put("dumbenemy",dumbenemy);
		this.props.put("de",dumbenemy);
		this.props.put("dumb",dumbenemy);
    }
    ...
    public void execute(Player sender, Player targetPlayer, List<String> args) {
        ...
        success = switch (prop.pseudoProp) {
			...
			case DUMB_ENEMY -> targetPlayer.dumb = value == 1 ? true : false;
